...
export default function DeliveryNotificationsScreen({ navigation }) {
  const { notifications, markAllAsRead, markAsRead, clearAll, resetTracking } = useDeliveryNotifications();
  ...
  const renderEmpty = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyMessage}>You're all caught up! New order assignments and updates will appear here.</Text>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  unreadItem: {
    ...
    borderLeftWidth: 3,
    borderLeftColor: DELIVERY_GREEN,
  },
  iconContainer: {
    width: 48,
    height: 48,
