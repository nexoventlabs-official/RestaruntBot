...
async function cleanCompletedOrders() {
  try {
    ...
    console.log(`✅ [Data Retention] Cleaned ${result.deletedCount} completed orders`);
    
    await metricsRedis.recordEvent('data_retention.orders_cleaned');
    
    return result.deletedCount;
  } catch (error) {
    console.error('❌ [Data Retention] Failed to clean completed orders:', error.message);
    return 0;
  }
}
...
async function cleanCancelledOrders() {
  try {
    ...
    console.log(`✅ [Data Retention] Cleaned ${result.deletedCount} cancelled orders`);
    
    await metricsRedis.recordEvent('data_retention.cancelled_orders_cleaned');
    
    return result.deletedCount;
  } catch (error) {
    console.error('❌ [Data Retention] Failed to clean cancelled orders:', error.message);
    return 0;
  }
}
...
async function cleanFailedPayments() {
  try {
    ...
    console.log(`✅ [Data Retention] Cleaned ${result.deletedCount} failed payments`);
    
    await metricsRedis.recordEvent('data_retention.failed_payments_cleaned');
    
    return result.deletedCount;
  } catch (error) {
    console.error('❌ [Data Retention] Failed to clean failed payments:', error.message);
    return 0;
  }
}
...
async function cleanInboundMessages() {
  try {
    ...
    console.log(`✅ [Data Retention] Cleaned ${result.deletedCount} inbound messages`);
    
    await metricsRedis.recordEvent('data_retention.inbound_messages_cleaned');
    
    return result.deletedCount;
  } catch (error) {
    console.error('❌ [Data Retention] Failed to clean inbound messages:', error.message);
    return 0;
  }
}
...
async function cleanOutboundMessages() {
  try {
    ...
    console.log(`✅ [Data Retention] Cleaned ${result.deletedCount} outbound messages`);
    
    await metricsRedis.recordEvent('data_retention.outbound_messages_cleaned');
    
    return result.deletedCount;
  } catch (error) {
    console.error('❌ [Data Retention] Failed to clean outbound messages:', error.message);
    return 0;
  }
}
...
async function archiveData(collection, query, archivePath) {
  try {
    ...
    console.log(`📦 [Data Retention] Archiving ${collection} data...`);
    
    // TODO: Implement actual archiving logic
    
    return true;
  } catch (error) {
    console.error('❌ [Data Retention] Failed to archive data:', error.message);
    return false;
  }
}
...
async function runRetentionPolicies() {
  console.log('🔄 [Data Retention] Running retention policies...');
  ...
  try {
    ...
    console.log(`✅ [Data Retention] Cleaned ${totalCleaned} records in ${duration}ms`);
    ...
    console.error('❌ [Data Retention] Failed to run retention policies:', error.message);
...
async function getRetentionStatus() {
  try {
    ...
    console.error('❌ [Data Retention] Failed to get retention status:', error.message);
