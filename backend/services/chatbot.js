...
const chatbot = {
  ...
  async reverseGeocode(latitude, longitude) {
    ...
    // Helper: small delay between API calls to avoid rate limits
    ...
    try {
      ...
      if (bdcResponse.data) {
        ...
        const parts = [];
        // Include street-level detail when available
    ...
    // Fallback: Google Maps link with coordinates (at least clickable/useful)
