...
const defaultImages = [
  ...
  { key: 'flow_welcome_banner', name: 'Flow: Welcome Banner', description: 'Banner image shown at top of welcome Flow service selection screen (thin landscape 5:1 ratio, e.g. 1000x200px)', imageUrl: '' },
