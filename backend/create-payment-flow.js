/**
 * Create Payment Method Selection Flow
 * Usage: node create-payment-flow.js
 */
...
async function main() {
  ...
  const flowJson = catalogService.buildPaymentFlowJSON();
  ...
  try {
    ...
    console.log(`\n✅ PUBLISHED: ${flowId}`);
    console.log(`Update .env: WHATSAPP_PAYMENT_FLOW_ID=${flowId}`);
  } catch (err) {
